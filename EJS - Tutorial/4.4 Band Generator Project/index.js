...
function generateBandName(){
  let randomDigit1 = Math.floor((Math.random()) * adj.length);
  let randomDigit2 = Math.floor((Math.random()) * noun.length);
  var bandName = adj[randomDigit1] + " " + noun[randomDigit2];
  return bandName;
}

//Step 3 - Make the styling show up.
//Hint 1: CSS files are static year: year}files!
